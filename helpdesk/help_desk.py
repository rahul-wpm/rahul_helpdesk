...
class HelpDesk(object):
    ...
    def __init__(self):
        ...
        self.padding_symbol = "X"  # padding symbol for encryption and decryption
    ...
    def connect_db(self):
        """
        @summary: Connects to MySQL localhost Database
    ...
    def encrypt_data(self, password):
        """
        @summary: This method encrypts the password given as argument
        @param password: Unencrpyted password
        @return: encrypted_value - Encrypted password
        """
        aes_size = 32
    ...
    def decrypt_data(self, password):
        """
        @summary: This method decrypts the encrypted password passed as argument
        @param password: Encrpyted password
        @return: decrypted_value - Decrypted password
        """
    ...
    def assign_staff(self, ticket_id, current_time, conn):
        ...
        @param ticket_id: This is the ticket ID for which staff id needs to
                                be assigned
        @param current_time: Current Time stamp value
        @param conn: Database connection object
        @return: staff_id - This is the user_id of the ADMIN staff assigned
                            for the passed ticket_id
        """
        cursor = conn.cursor()
        ...
        if staff_list:
            for per_staff in staff_list:
                ...
                name = staff_details['firstname'] + ' ' + staff_details[
                    'lastname']
    ...
    def fetch_open_tickets(self, user_id, user_type):
        """
        @summary : This method fetches the NEW and OPEN tickets for given
                    user_type and user_id
        @param user_id: This is the user ID of either CUSTOMER / ADMIN
        @param user_type: THis is either ADMIN/ CUSTOMER
        @return: open_ticket_list - List containing result dicts of each record
                                    of OPEN ticket from database.
        """
        # import pdb;pdb.set_trace()
        if user_type == 'ADMIN':
            type = 'asignee_id'
    ...
    def customer_portal(self, customer_id, email_id):
        """
        @summary : This method is used by customers logged in as ADMIN.
                   This displays various options for the admin like :
                   1. Raise a Ticket
                   2. View Open tickets
                   3. Add Followup to Open Ticket
                   4. Logout
        :param customer_id:
        :param email_id:
        :return:
        ...
        if option == '1':
            ...
            insert_ticket_details = """INSERT INTO HelpDesk_Ticket (
                             customer_id,subject,content,status,created_date)\
                            VALUES('%s','%s','%s','%s','%s')""" % (
                customer_id,
                ticket_subject,
                ticket_content,
    ...
    def admin_portal(self, asignee_id, email_id):
        ...
        @summary : This method is used by customers logged in as ADMIN.
                   This displays various options for the admin like :
                   1. View Assigned/Open Tickets
                   2. Reply/Open tickets
                   3. Close tickets
                   4. View Ticket History
                   4. Logout
        @param asignee_id: This is the logged in ADMIN user ID
        @param email_id: The email ID of the logged in admin
        @return: None
        """
    ...
    def login(self):
        """
        @summary : This method gets the email ID and Password and verifies it
                   with the detials in the database and then makes the user
                   logged in.
        @return: None
        """
        try:
    ...
    def customer_signup(self):
        """
        @summary: This method is used to register the User either as an
                    ADMIN
                     (OR)
                    CUSTOMER.
                    This method also fetches user details and stores it in the
                    database.
        @return:  None
        """
    ...
    def home_page(self):
        """
        @summary : Shows list of options like Login , SIgnUp and Exit.
        @return: None
        """
